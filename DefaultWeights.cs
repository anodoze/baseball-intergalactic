namespace Basedball
{
	public static class FieldDefaults
	{
		...
		public static readonly Dictionary<Handedness, DirectionWeights> DefaultDirectionWeights =
			new()
			{
		...
		public static readonly Dictionary<Angle, FieldingOutcomeWeights> DefaultFieldingWeights =
			new()
			{
		...
		public static readonly Dictionary<Force, FieldingOutcomeWeights> ForceFieldingModifiers =
			new()
			{
